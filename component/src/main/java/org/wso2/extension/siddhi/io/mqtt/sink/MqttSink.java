...
@Extension(
        ...
        parameters = {
                ...
                @Parameter(
                        name = "clean.session",
                        description = "This is an optional parameter. If this parameter is set to `true`, the " +
                                "subscriptions made by the MQTT client during a session expire when the session " +
                                "ends, and they need to be recreated for the next session.\n" +
                                ...
                                " the connection is re-established with " +
